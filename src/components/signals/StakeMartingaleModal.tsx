...
export const StakeMartingaleModal: React.FC<StakeMartingaleModalProps> = ({
    ...
    useEffect(() => {
        if (isOpen) {
            ...
            setAggressiveMode(settings.aggressiveMode);
            setErrors({});
        }
    }, [isOpen]);
    ...
    const handleProceed = () => {
        if (validateInputs()) {
            ...
            stakeManager.updateSettings(stakeNum, martingaleNum, aggressiveMode);
        ...
        <div className='stake-martingale-modal-overlay' onClick={onClose}>
            ...
            >
                ...
                <div className='stake-martingale-modal__content'>
                    ...
                    <div className='stake-martingale-modal__field'>
                        <div className='stake-martingale-modal__toggle-wrapper'>
                            <label className='stake-martingale-modal__toggle-label'>
                                <input
                                    type='checkbox'
                                    className='stake-martingale-modal__toggle-input'
                                    checked={aggressiveMode}
                                    onChange={e => setAggressiveMode(e.target.checked)}
                                />
                                <span className='stake-martingale-modal__toggle-slider'></span>
                                <span className='stake-martingale-modal__toggle-text'>
                                    🔥 Aggressive Mode
                                </span>
                            </label>
                        </div>
                        <div className='stake-martingale-modal__toggle-description'>
                            When enabled, recovery prediction will be the same as start prediction
                        </div>
                    </div>
                    ...
                    <div className='stake-martingale-modal__info'>
                        ...
                        <p>
                            ...
                            <strong>{stakeManager.getAggressiveMode() ? 'Aggressive' : 'Standard'}</strong> mode
                        </p>
                    </div>
                </div>
